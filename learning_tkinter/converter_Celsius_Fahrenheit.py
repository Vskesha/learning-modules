...
lb = Label(root, text='Введи температуру: ', font=(
    'Arial', 12, 'bold'), fg='lime', bg='black')
lb.pack(pady=10)

e = Entry(root, font='Arial 16 bold', bg='lime', width=5)
e.pack()

btn1 = Button(root, text='Перевести в °F', font='Arial 10 bold',
              pady=5, padx=5, bg='lime', command=convertF)
btn1.pack(pady=10)

btn2 = Button(root, text='Перевести в °C', font='Arial 10 bold',
              pady=5, padx=5, bg='lime', command=convertC)
btn2.pack()
